...
public class WhenLocatingElements {
    ...
    @Test
    public void finding_the_quote_by_class() {
        // TODO: Find the Quote text by classname
        WebElement quote = driver.findElement(By.className("quote speech-bubble"));
    ...
    public void finding_the_quote_by_css() {
        ...
        WebElement quote = driver.findElement(By.cssSelector(".quote.speech-bubble"));;
    ...
    public void finding_the_new_todo_field_by_xpath() {
        ...
        WebElement todoField = driver.findElement(By.xpath("//input[@placeholder=\"What needs to be done?\"]"));
